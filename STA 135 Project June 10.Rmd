...
```{r}
## PCA
a <- PimaIndiansDiabetesClean[, -9] # Removing the class variable 'diabetes'
ev <- eigen((cov(a)))$values
eve <- eigen(cov(a))$vectors
l1 <- eve[1:8,1] %*% t(a)
l2 <- eve[1:8,2] %*% t(a)
plot(-l1[1,1:nrow(PimaIndiansDiabetesClean)], l2[1,1:nrow(PimaIndiansDiabetesClean)], main="PCA Plot")
